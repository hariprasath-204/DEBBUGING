...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <div style={{ height: '100vh', width: '100vw', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', transition: 'opacity 0.3s', opacity: showModal ? 0.2 : 1, pointerEvents: showModal ? 'none' : 'auto' }}>
          ...
          <h1 className="gradient-title" style={{ fontSize: '5.5rem', margin: '0', lineHeight: '1.1', fontFamily: 'var(--font-heading)' }}>SOFTTECH</h1>
          <h1 className="glow-text-magenta" style={{ fontSize: '4rem', margin: '0 0 1rem 0', letterSpacing: '10px' }}>ASSOCIATION</h1>
          
          <h4 style={{ color: 'var(--text-secondary)', letterSpacing: '6px', fontSize: '1rem', marginBottom: '2rem', textTransform: 'uppercase', fontFamily: 'var(--font-body)', fontWeight: '400' }}>
            THE ULTIMATE DEBUGGING CHALLENGE
          </h4>

          <button className="btn-primary" style={{ fontSize: '1.1rem', padding: '14px 40px' }} onClick={() => setShowModal(true)}>
            &gt; START_SYSTEM
          </button>
        </div>
        ...
        <p style={{ position: 'absolute', bottom: '16px', left: 0, right: 0, textAlign: 'center', color: 'var(--text-secondary)', fontSize: '0.78rem', letterSpacing: '1px' }}>
